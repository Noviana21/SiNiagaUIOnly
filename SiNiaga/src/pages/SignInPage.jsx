        ...
        <div className="min-h-screen flex items-center flex-col justify-center px-6 pb-4 mt-16 scroll-smooth md:scroll-auto">
            <div className="max-w-7xl w-full">
                <div className="grid md:grid-cols-5 gap-2 ml-8 items-center justify-center">
                    <div className="md:col-span-2 flex p-2 m-2" data-aos="fade-right">
                        <img
                            src={signin}
                            alt="Sign Logo"
                            className="w-full max-w-sm max-h-100 object-cover ml-4"
                        />
                    </div>
                    <div className="md:col-span-3 px-8 py-2 text-center flex flex-col max-w-xl">
                        <div data-aos="fade-right">
                            <h1 className="text-4xl font-bold custom-h1">Sign In to Your Account</h1>
                            <p className="px-2 mb-4">Please enter your credentials to sign in</p>
                        </div>
                        <div className="space-y-4 p-8 m-2 max-w-lg bg-white rounded-xl shadow-lg" data-aos="fade-right">
                            <form>
                                <div>
                            ...
                            <div className="mt-4 text-gray-600">
                                <p className="text-sm">Don't have an account? <Link to="/signup" className="text-[#6b7f61] hover:underline">Sign Up</Link></p>
                            </div>
                        </div>
                    </div>
                </div>
